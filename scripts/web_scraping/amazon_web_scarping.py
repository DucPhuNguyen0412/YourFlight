...
if __name__ == '__main__':
    ...
    models = ['playstation+4', 'playstation+5']  # The list of models to search for

    d = {"model": [], "title":[], "price":[], "rating":[], "reviews":[], "availability":[]}
    ...
    amazon_df.to_csv("/Users/macbook/Documents/Documents - Macbook’s MacBook Pro/ISTT/AirflowTutorial/data/raw/amazon_data.csv", header=True, index=False)
