...
for model in "${model_array[@]}"; do
    ...
    python3 /Users/macbook/Documents/Documents_MacBook_Pro/ISTT/AirflowTutorial/src/scripts/web_scraping/ebay_web_scraping.py "$model"
    ...
    python3 /Users/macbook/Documents/Documents_MacBook_Pro/ISTT/AirflowTutorial/src/scripts/spark/process_ebay_data.py "$model"
